...
project = 'Labo_GIF270'
copyright = '2023-2024, Frédéric Mailhot'
...
# ones.
extensions = ['sphinx_search.extension', 'sphinx.ext.napoleon', 'sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'sphinx_pyreverse']

sphinx_pyreverse_show_ancestors = "1"
